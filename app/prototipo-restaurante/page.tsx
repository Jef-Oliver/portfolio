...
export const metadata: Metadata = {
  title: 'Protótipo Interativo | RestaurantePRO - Jeferson Oliveira',
  description: 'Experimente o protótipo funcional do sistema de gestão para restaurantes.',
};

export default function PrototipoRestaurantePage() {
  const whatsappMsg = encodeURIComponent(
    'Olá Jeferson! Testei o protótipo do RestaurantePRO e quero um sistema sob medida para meu negócio.'
  );
  ...
  return (
    <div className="flex flex-col w-screen h-screen bg-black overflow-hidden select-none">
      ...
      <main className="flex-1 w-full h-[calc(100vh-3.5rem)] relative bg-[#0f0a0a]">
        <iframe
          src="/prototipo-restaurante.html"
          title="Protótipo RestaurantePRO"
